<template>
  <div>
    <div class="dvs-flex dvs-items-center">
      <input v-model="value" type="text" :maxlength="getMaxLength" disabled />
      <div @click="showMediaManager()">
        <document-icon class="dvs-ml-4 dvs-cursor-pointer" w="30px" h="30px" />
      </div>
      <div :class="{ ' dvs-opacity-25': !previewEnabled }" @click="loadPreview">
    ...
    <div v-if="showPreview">
      <portal to="devise-root">
        ...
        ></div>
        <div
          class="dvs-modal dvs-fixed dvs-bottom-0 dvs-right-0 dvs-mx-8 dvs-mb-8 dvs-z-40 dvs-w-1/2"
        >
          <img :src="value" />
