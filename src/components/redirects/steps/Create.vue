<template>
  <form @submit.prevent="">
    <fieldset class="dvs-fieldset dvs-mb-4">
      ...
      <input v-model="newRedirect.from_url" type="text" />
    </fieldset>

    <fieldset class="dvs-fieldset dvs-mb-4">
      <label>To URL</label>
      <input v-model="newRedirect.to_url" type="text" />
    </fieldset>
...
export default {
  ...
  computed: {
    createInvalid() {
      return this.newRedirect.from_url === null || this.newRedirect.to_url === null
    },
  },
  methods: {
