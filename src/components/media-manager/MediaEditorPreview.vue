      ...
      <div class="dvs-p-8">
        ...
        >
          ...
          >
            <h3
              class="
                dvs-p-4 dvs-px-8 dvs-uppercase dvs-border-b dvs-border-white dvs-pb-4 dvs-text-red
              "
            >
              Warning
            </h3>
        ...
        <div v-if="isCropping" class="dvs-relative dvs-z-40 dvs-bg-black dvs-rounded dvs-shadow-lg">
