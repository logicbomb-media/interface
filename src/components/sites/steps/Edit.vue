<template>
  <form @submit.prevent="">
    <fieldset class="dvs-fieldset dvs-mb-4">
      <label>Name</label>
      <input v-model="localValue.name" type="text" placeholder="Name of the Site" class="w-full" />
    </fieldset>

    <fieldset class="dvs-fieldset dvs-mb-4">
      <label>
        Domain
        <help class="dvs-mb-8" :compact="true">
    ...
    <fieldset class="dvs-fieldset dvs-mb-4">
      ...
      <select v-model="localValue.language_id" type="text" class="w-full">
        <option :value="null" disabled>Select a Default Language</option>
...
export default {
  ...
  computed: {
    ...
    editInvalid() {
      return !this.localValue.name || !this.localValue.domain || !this.localValue.language_id
    },
  },
  mounted() {
