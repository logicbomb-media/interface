<template>
  <form @submit.prevent="">
    <fieldset class="dvs-fieldset dvs-mb-4">
      <label>Name</label>
      <input v-model="newSite.name" type="text" placeholder="Name of the Site" class="w-full" />
    </fieldset>
    ...
    <fieldset class="dvs-fieldset dvs-mb-4">
      ...
      <input v-model="newSite.domain" type="text" placeholder="Domain of the Site" class="w-full" />
    </fieldset>

    <fieldset class="dvs-fieldset dvs-mb-4">
      <label>Language</label>
      <select v-model="newSite.language_id" type="text" class="w-full">
