...
export default {
  ...
  methods: {
    ...
    setTabletMarginPadding(payload) {
      ...
      if (payload.type === 'padding' && typeof this.slice.settings.tablet_padding === 'undefined') {
    ...
    setMobileMarginPadding(payload) {
      ...
      if (payload.type === 'padding' && typeof this.slice.settings.mobile_padding === 'undefined') {
